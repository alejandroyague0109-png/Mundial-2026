    ...
    try {
        const driverObj = driver({
            ...
            steps: [
                ...
                { element: elementoAiluminar, popover: { title: 'Tus Repetidas 💰', description: 'Si dejás el precio en 0, es solo para <b>CANJE</b>. Si le ponés un valor, pasa a <b>VENTA</b>. Además, si tocás el <b>interruptor con la ⭐</b>, la marcás como <b>VERSIÓN ESPECIAL</b> (ideal para las metalizadas o extra stickers). Desde acá también indicás la <b>CANTIDAD</b>.', side: "top", align: 'center' } },
